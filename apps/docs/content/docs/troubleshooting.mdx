...
- Authentication expires after 15 minutes, reconnect if timed out
...
- Authentication request timed out (15 minutes)
...
In SSH reverse tunnel mode, `Ctrl+C` **does not** terminate the connection.
